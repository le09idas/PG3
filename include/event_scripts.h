...
extern const u8 RustboroCity_Gym_EventScript_RoxanneRematchCall[];
extern const u8 DewfordTown_Gym_EventScript_BrawlyRematchCall[];
extern const u8 MauvilleCity_Gym_EventScript_WattsonRematchCall[];
extern const u8 LavaridgeTown_Gym_1F_EventScript_FlanneryRematchCall[];
extern const u8 PetalburgCity_Gym_EventScript_NormanRematchCall[];
extern const u8 FortreeCity_Gym_EventScript_WinonaRematchCall[];
extern const u8 MossdeepCity_Gym_EventScript_TateAndLizaRematchCall[];
extern const u8 SootopolisCity_Gym_1F_EventScript_JuanRematchCall[];
